      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-20">
          ...
          <motion.a
            ...
            whileTap={{ scale: 0.95 }}
          >
            <span className="text-primary-700">Hanbara</span>
          </motion.a>
          ...
          <div className="hidden md:flex items-center space-x-8">
            ...
            <motion.a
              href="#contact"
              className="px-6 py-2 bg-gradient-to-r from-primary-600 to-primary-500 text-white rounded-full font-medium shadow-lg hover:shadow-xl transition-all duration-300"
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
            >
              Nous contacter
        ...
        {isMobileMenuOpen && (
          ...
          >
            <div className="px-4 py-4 space-y-4">
              ...
              <a
                href="#contact"
                className="block px-6 py-2 bg-gradient-to-r from-primary-600 to-primary-500 text-white rounded-full font-medium text-center"
                onClick={() => setIsMobileMenuOpen(false)}
              >
                Nous contacter
              </a>
